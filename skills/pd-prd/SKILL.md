...
2. 生成 `prd.md`，覆盖背景、目标、用户角色、核心场景、功能范围、非目标范围、业务规则、用户流程、验收标准、假设与风险、开放问题。
3. 生成 `requirements.md`，按需求 ID、优先级、来源和验收标准整理功能点。
4. 生成 `user-stories.md`，用用户角色、我想要、以便于、验收标准表达需求。
5. 生成 `acceptance-criteria.md`，明确功能、状态、边界和非目标验收。
6. 生成 `open-questions.md`，列出需要用户、业务、设计或技术确认的问题。
