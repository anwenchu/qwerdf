...
SKILL_HINTS = {
    ...
    "pd-blueprint": ["产品设计输入", "页面蓝图", "页面地图", "页面规格", "组件清单", "用户流程", "ui 设计系统", "UI设计系统"],
    "pd-figma": ["figma", "ui 方向", "ui方向", "写到 figma", "figma 设计", "ui 设计系统", "UI设计系统"],
    "pd-ui-review": ["ui review", "设计稿 review", "figma review", "视觉审查", "页面看起来不对", "样式不统一", "字体不统一", "遮挡", "重叠", "不整齐", "移动端溢出", "截图审查"],
    "pd-plan": ["技术设计", "技术方案", "api 契约", "数据模型", "task-slices", "任务切片", "UI技术设计"],
    "pd-fe": ["fe-", "前端 slice", "前端任务", "前端筛选", "api client", "前端验收", "前端UI验收"],
    ...
    "pd-review": ["code review", "review 当前", "代码审查", "提交前审查", "审查改动", "测试缺口", "状态覆盖", "UI 设计质量"],
